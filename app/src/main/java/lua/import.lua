...
local LuaAsyncTask = luajava.bindClass("com.androluna.LuaAsyncTask")
local LuaThread = luajava.bindClass("com.androluna.LuaThread")
local LuaTimer = luajava.bindClass("com.androluna.LuaTimer")
